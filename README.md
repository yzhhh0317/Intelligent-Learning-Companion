# 🧠 无线通信智能学习伴侣 - 基于 RAG 技术的个人知识管理系统

> 一个集智能问答、内容处理、知识管理于一体的无线通信学习助手，采用检索增强生成(RAG)技术，为个人在无线通信领域的学习提供智能化支持。
...
无线通信智能学习伴侣是一个基于**检索增强生成(RAG)**技术构建的无线通信知识管理系统，通过先进的**混合检索算法**和**DeepSeek 大模型**，为用户提供个性化的学习问答和知识管理服务。

### 🎯 核心特色

- **🔍 混合检索引擎**：语义搜索 + BM25 + RRF 融合，提升检索鲁棒性
- **🧠 智能向量化**：HuggingFace sentence-transformers(384D)为主，改进 TF-IDF(100D)为备用方案
- **💾 存储架构**：内存+MongoDB 混合存储，向量索引优化检索性能
- **🤖 AI 深度集成**：DeepSeek R1 大模型，专业 Prompt 工程，支持多角色智能生成
- **📊 性能监控体系**：内置性能评估模块，支持检索质量和响应时间监控
...
![RAG控制台](images/rag.png)

## 🚀 功能特性

### 1. 智能问答系统

- **🤖 RAG 增强问答**：基于无线通信知识库的上下文感知问答
- **📚 多源融合**：整合历史笔记、当前内容和通用知识
- **🎯 精准溯源**：显示答案来源和匹配度

### 2. 内容处理引擎

- **📄 智能摘要**：AI 驱动的内容总结，支持可配置压缩比例
