...
class ObsidianFileLoader extends base_1.BaseDocumentLoader {
    ...
    static async imports() {
        try {
            const { basename } = await Promise.resolve().then(() => __importStar(require("node:path")));
            const { readFile, stat } = await Promise.resolve().then(() => __importStar(require("node:fs/promises")));
