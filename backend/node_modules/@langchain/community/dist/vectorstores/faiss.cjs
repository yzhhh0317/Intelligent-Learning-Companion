...
class FaissStore extends vectorstores_1.SaveableVectorStore {
    ...
    static async importFaiss() {
        try {
            const { default: { IndexFlatL2 }, } = await Promise.resolve().then(() => __importStar(require("faiss-node")));
            return { IndexFlatL2 };
    ...
    static async importPickleparser() {
        try {
            const { default: { Parser, NameRegistry }, } = await Promise.resolve().then(() => __importStar(require("pickleparser")));
