 ...
 */
export const mem0MemoryContextToSystemPrompt = (memory) => {
 ...
 */
export const condenseMem0MemoryIntoHumanMessage = (memory) => {
 ...
 */
export const mem0MemoryToMessages = (memories) => {
 ...
 * ```
 */
export class Mem0Memory extends BaseChatMemory {
    constructor(fields) {
        if (!fields.apiKey) {
    ...
    async loadMemoryVariables(values) {
        ...
        return {
            [this.memoryKey]: this.separateMessages
                ? getBufferString(mem0MemoryToMessages(memories), this.humanPrefix, this.aiPrefix)
