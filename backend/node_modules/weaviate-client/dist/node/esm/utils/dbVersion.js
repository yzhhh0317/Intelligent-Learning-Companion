...
export class DbVersionSupport {
    constructor(dbVersionProvider) {
        ...
        this.supportsHNSWAndBQ = () => this.dbVersionProvider.getVersion().then((version) => {
            return {
                version: version,
        ...
        this.supportsBm25AndHybridGroupByQueries = () => this.dbVersionProvider.getVersion().then((version) => {
            return {
                version: version,
        ...
        this.supportsMultiWeightsPerTargetSearch = () => {
            return this.dbVersionProvider.getVersion().then((version) => {
                return {
                    version: version,
                    supports: version.isAtLeast(1, 27, 0),
                    message: this.errorMessage('Multi-target vector search with multiple weights', version.show(), '1.27.0'),
                };
            });
        };
