...
import { BooleanArrayProperties, consistencyLevelFromJSON, consistencyLevelToJSON, Filters, IntArrayProperties, NumberArrayProperties, ObjectArrayProperties, ObjectProperties, TextArrayProperties, Vectors, } from "./base.js";
...
export const PropertiesResult = {
    ...
    fromPartial(object) {
        ...
        message.refProps = ((_b = object.refProps) === null || _b === void 0 ? void 0 : _b.map((e) => RefPropertiesResult.fromPartial(e))) || [];
