...
declare const app: {
    ...
    reconfigure: {
        ...
        vectorizer: {
            update: <N_54 extends string | undefined, I_54 extends string>(options: import("./collections/index.js").VectorizerUpdateOptions<N_54, I_54>) => import("./collections/index.js").VectorConfigUpdate<N_54, I_54>;
        };
        vectors: {
