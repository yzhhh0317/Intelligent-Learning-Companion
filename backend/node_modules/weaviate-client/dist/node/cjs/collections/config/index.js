...
const config = (connection, name, dbVersionSupport, tenant) => {
    ...
    return {
        ...
        addReference: (reference) => new index_js_1.PropertyCreator(connection)
            ...
            .do()
            .then(() => { }),
        addVector: (vectors) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        update: (config) => {
            return getRaw()
                .then((current) => __awaiter(void 0, void 0, void 0, function* () {
                return classes_js_1.MergeWithExisting.schema(current, yield dbVersionSupport.supportsNamedVectors().then((s) => s.supports), config);
            }))
